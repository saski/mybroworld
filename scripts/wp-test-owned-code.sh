...
if command -v node >/dev/null 2>&1; then
  ...
  node --test scripts/wp-smoke-test.test.mjs scripts/wp-inventory-parity.test.mjs scripts/woo-catalog-sync.test.mjs scripts/woo-storefront-assert.test.mjs scripts/woo-storefront-ux-assert.test.mjs scripts/woo-image-quality-audit.test.mjs scripts/woo-visual-baseline.test.mjs scripts/woo-interaction-baseline.test.mjs
else
