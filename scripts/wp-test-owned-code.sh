...
if command -v node >/dev/null 2>&1; then
  ...
  node --test scripts/wp-smoke-test.test.mjs scripts/wp-inventory-parity.test.mjs scripts/woo-catalog-sync.test.mjs scripts/woo-storefront-assert.test.mjs
else
