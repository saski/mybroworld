...
- `commerce-platform-decision`: Evidence-based decision between continuing WooCommerce and testing a leaner ecommerce approach.
...
- `commerce-flow-test-coverage`: Automated coverage for publishing, catalog, shop, checkout, and plugin-removal smoke flows.
- `ecommerce-visual-identity`: Customer-approved visual identity process for the ecommerce experience.
